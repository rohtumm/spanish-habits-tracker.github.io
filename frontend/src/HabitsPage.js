...
function HabitsPage() {
  ...
  const habits = ['Hablar con amigos (15 min.)', 
    'Ir a tutoría', 
    'La mesa de conversación',
    'Hablar con un Pen-Pal',
    'Hablar con un hispano (15 min.)',
    'Enseñar español',
    'Leer las noticias',
    'Lee un libro (Un capítulo)',
    'Estudiar en  Conjuguemos',
    'Leer un artículo',
    'Escuchar un podcast',
    'Mirar videos en Youtube (20 m)',
    'Escuchar música (15 min.)',
    'Escuchar la radio (15 min.)',
    'Duolingo (15 min.)',
    'Mirar una película',
    ...
    'Estudiar en conjuguemos (15 min.)',
    'Estudiar en Quizlet (15 min.)',
    'Escribir un cuento',
  ...
  //const habits = Array.from({ length: 28 }, (_, i) => `Habit ${i + 1}`); // 28 habits
